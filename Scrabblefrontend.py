...
def directionfunction(direction):
   ...
   """
   if direction == 'up':
      direction_num.append(1)
   if direction == 'down':
      direction_num.append(2)
   if direction == 'right':
      direction_num.append(3)
   if direction == 'left':
      direction_num.append(4)
...
matrix = [[M00, M01, M02, M03, M04], [M10, M11, M12, M13, M14], [M20, M21, M22, M23, M24], [M30, M31, M32, M33, M34], [M40, M41, M42, M43, M44]]
